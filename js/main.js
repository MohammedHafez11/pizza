    ...
    "use strict";
     ...
     $(document).ready(function () {
         ...
         /* -----------------------------------------------------
             Variables
         ----------------------------------------------------- */
         var leftArrow = '<i class="ri-arrow-right-line"></i>';
         var leftAngle = '<i class="ri-arrow-right-s-line"></i>';
         var rightArrow = '<i class="ri-arrow-left-line"></i>';
         var rightAngle = '<i class="ri-arrow-left-s-line"></i>';
         var backButton = '<button class="slide-arrow prev-arrow"><i class="fa fa-angle-right"></i></button>';
         var nextButton = '<button class="slide-arrow next-arrow"><i class="fa fa-angle-left"></i></button>';
